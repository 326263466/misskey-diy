...
export type NotesLikesRequest = operations['notes___likes']['requestBody']['content']['application/json'];
export type NotesLikesResponse = operations['notes___likes']['responses']['200']['content']['application/json'];
export type NotesLikesCreateRequest = operations['notes___likes___create']['requestBody']['content']['application/json'];
export type NotesLikesCreateResponse = operations['notes___likes___create']['responses']['200']['content']['application/json'];
export type NotesLikesDeleteRequest = operations['notes___likes___delete']['requestBody']['content']['application/json'];
export type NotesLikesDeleteResponse = operations['notes___likes___delete']['responses']['200']['content']['application/json'];
...
export type NotesViewsRequest = operations['notes___views']['requestBody']['content']['application/json'];
