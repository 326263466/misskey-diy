...
const $noteLikesRepository: Provider = {
	provide: DI.noteLikesRepository,
	useFactory: (db: DataSource) => db.getRepository(MiNoteLike).extend(miRepository as MiRepository<MiNoteLike>),
	inject: [DI.db],
};
